...
import com.darosa.app.databinding.ActivityPageGuruBinding
...
class PageGuruActivity : AppCompatActivity() {

    private lateinit var binding: ActivityPageGuruBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPageGuruBinding.inflate(layoutInflater)
                    ...
                    if (pages != null) {
                        ...
                        documentRef.update("pages", updatedPages)
                            .addOnSuccessListener {
                                Toast.makeText(
                                    this,
                                    "Halaman sudah selesai divalidasi",
                                    Toast.LENGTH_SHORT
                                ).show()
                                binding.progressBarDialog.root.hide()
                                finish()
                            ...
                            .addOnFailureListener {
                                Log.d(TAG, "Gagal update data validasi")
                            }
                    }
                }
            }
